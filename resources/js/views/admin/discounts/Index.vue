        ...
        <div class="col-md-12">
            <div class="card border-0">
                <div class="card-header bg-transparent">
                    <h5 class="float-start">Discounts</h5>
                    <router-link v-if="can('discount-create')" :to="{ name: 'discounts.create' }"
                ...
                <div class="card-body shadow-sm">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="px-6 py-3 bg-gray-50 text-left">
                                        <div class="flex flex-row discounts-center justify-between cursor-pointer"
                            ...
                            <tbody>
                                <tr v-for="post in discounts.data" :key="post.id">
                ...
                <div class="card-footer">
                    <Pagination :data="discounts" :limit="3"
                        @pagination-change-page="page => getDiscounts(page, search_id, search_title, search_global, orderColumn, orderDirection)"
                        class="mt-4" />
                </div>
            </div>
        </div>
